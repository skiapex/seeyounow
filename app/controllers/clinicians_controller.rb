class CliniciansController < ApplicationController
  ...
  private
    ...
    def clinician_params
      ...
      params.require(:clinician).permit(:first_name,:last_name,:occupation_id, :speciality_id,:gender_id, :office_number, :mobile_number, :emergency_message, :care_group_id, :administrator, :user_id, user_attributes: [ :email, :password, :patient_id, :clinician_id, :terms_agreement ])
    end
