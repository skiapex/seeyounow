...
urine = OtherSypmtom.create(sypmtom_type: "discoloured urine")
...
EsasAssesment.create(patient_id: johndoe.id, clinician_id: drmarshallsmith.id, time: "13:53:21 2014-10-05", inputter_name: "Jane Doe", inputter_id: "partner.id", pain: 5, pain_comment: "little worse", tiredness: 5, tiredness_comment: nil, drowsiness: 5, drowsiness_comment: nil, nausea: 4, nausea_comment: nil, lack_of_appetite: 8, lack_of_appetite_comment: nil, shortness_of_breath: 4, shortness_of_breath_comment: nil, depression: 3, depression_comment: nil, wellbeing: 5, wellbeing_comment: nil, other_sypmtom_id: constipation.id, other_sypmtom_score: 6, other_sypmtom_comment: nil, esas_comment: "More pain today, meds not strong enough")
EsasAssesment.create(patient_id: johndoe.id, clinician_id: drmarshallsmith.id, time: "12:45:45 2014-10-06", inputter_name: "Jane Doe", inputter_id: "partner.id", pain: 4, pain_comment: nil, tiredness: 5, tiredness_comment: nil, drowsiness: 7, drowsiness_comment: nil, nausea: 3, nausea_comment: nil, lack_of_appetite: 7, lack_of_appetite_comment: nil, shortness_of_breath: 3, shortness_of_breath_comment: nil, depression: 3, depression_comment: nil, wellbeing: 4, wellbeing_comment: nil, other_sypmtom_id: constipation.id, other_sypmtom_score: 7, other_sypmtom_comment: nil, esas_comment: nil)
...
EsasAssesment.create(patient_id: cindypeters.id, clinician_id: joandixon.id, time: "15:43:21 2014-10-06", inputter_name: "Paul Ku", inputter_id: "care_aid.id", pain: 8, pain_comment: nil, tiredness: 6, tiredness_comment: nil, drowsiness: 5, drowsiness_comment: nil, nausea: 7, nausea_comment: nil, lack_of_appetite: 8, lack_of_appetite_comment: nil, shortness_of_breath: 5, shortness_of_breath_comment: nil, depression: 5, depression_comment: nil, wellbeing: 7, wellbeing_comment: nil, other_sypmtom_id: sweating.id, other_sypmtom_score: 6, other_sypmtom_comment: "Still leading to dehydration", esas_comment: "She hasn't eaten anything all day and is barely drinking enough to replace the fluids lost from sweating")
EsasAssesment.create(patient_id: cindypeters.id, clinician_id: drmarshallsmith.id, time: "10:02:34 2014-10-08", inputter_name: "Paul Ku", inputter_id: "care_aid.id", pain: 9, pain_comment: nil, tiredness: 5, tiredness_comment: nil, drowsiness: 7, drowsiness_comment: nil, nausea: 8, nausea_comment: nil, lack_of_appetite: 9, lack_of_appetite_comment: nil, shortness_of_breath: 5, shortness_of_breath_comment: nil, depression: 5, depression_comment: nil, wellbeing: 7, wellbeing_comment: nil, other_sypmtom_id: sweating.id, other_sypmtom_score: 3, other_sypmtom_comment: "Still leading to dehydration", esas_comment: nil)

EsasAssesment.create(patient_id: yiwang.id, clinician_id: rachellmiddleton.id, time: "11:03:32 2014-10-04", inputter_name: "Tania Abbot", inputter_id: "care_aid.id", pain: 4, pain_comment: nil, tiredness: 6, tiredness_comment: nil, drowsiness: 6, drowsiness_comment: nil, nausea: 3, nausea_comment: nil, lack_of_appetite: 8, lack_of_appetite_comment: nil, shortness_of_breath: 2, shortness_of_breath_comment: nil, depression: 2, depression_comment: nil, wellbeing: 4, wellbeing_comment: nil, other_sypmtom_id: sweating.id, other_sypmtom_score: 9, other_sypmtom_comment: nil, esas_comment: nil)
EsasAssesment.create(patient_id: yiwang.id, clinician_id: rachellmiddleton.id, time: "13:53:21 2014-10-05", inputter_name: "Tania Abbot", inputter_id: "care_aid.id", pain: 5, pain_comment: "little worse", tiredness: 5, tiredness_comment: nil, drowsiness: 5, drowsiness_comment: nil, nausea: 4, nausea_comment: nil, lack_of_appetite: 8, lack_of_appetite_comment: nil, shortness_of_breath: 4, shortness_of_breath_comment: nil, depression: 3, depression_comment: nil, wellbeing: 5, wellbeing_comment: nil, other_sypmtom_id: sweating.id, other_sypmtom_score: 6, other_sypmtom_comment: nil, esas_comment: "He is complaining about chest pains")
EsasAssesment.create(patient_id: yiwang.id, clinician_id: macariogarcia.id, time: "15:43:21 2014-10-06", inputter_name: "Louis Wang", inputter_id: "son.id", pain: 4, pain_comment: nil, tiredness: 5, tiredness_comment: nil, drowsiness: 7, drowsiness_comment: nil, nausea: 3, nausea_comment: nil, lack_of_appetite: 7, lack_of_appetite_comment: nil, shortness_of_breath: 3, shortness_of_breath_comment: nil, depression: 3, depression_comment: nil, wellbeing: 4, wellbeing_comment: nil, other_sypmtom_id: sweating.id, other_sypmtom_score: 7, other_sypmtom_comment: nil, esas_comment: nil)

EsasAssesment.create(patient_id: apwinderbrar.id, clinician_id: rachellmiddleton.id, time: "09:08:56 2014-10-04", inputter_name: "Saranjit Brar", inputter_id: "partner.id", pain: 7, pain_comment: nil, tiredness: 5, tiredness_comment: nil, drowsiness: 6, drowsiness_comment: nil, nausea: 8, nausea_comment: nil, lack_of_appetite: 7, lack_of_appetite_comment: nil, shortness_of_breath: 4, shortness_of_breath_comment: nil, depression: 5, depression_comment: nil, wellbeing: 6, wellbeing_comment: nil, other_sypmtom_id: urine.id, other_sypmtom_score: 4, other_sypmtom_comment: "Blood in urine", esas_comment: nil)
EsasAssesment.create(patient_id: apwinderbrar.id, clinician_id: rachellmiddleton.id, time: "08:43:21 2014-10-06", inputter_name: "Saranjit Brar", inputter_id: "partner.id", pain: 8, pain_comment: nil, tiredness: 6, tiredness_comment: nil, drowsiness: 5, drowsiness_comment: nil, nausea: 7, nausea_comment: nil, lack_of_appetite: 8, lack_of_appetite_comment: nil, shortness_of_breath: 5, shortness_of_breath_comment: nil, depression: 5, depression_comment: nil, wellbeing: 7, wellbeing_comment: nil, other_sypmtom_id: urine.id, other_sypmtom_score: 6, other_sypmtom_comment: "Brown in urine", esas_comment: "He is worried that he is feeling worse today")
EsasAssesment.create(patient_id: apwinderbrar.id, clinician_id: macariogarcia.id, time: "09:02:34 2014-10-08", inputter_name: "Saranjit Brar", inputter_id: "partner.id", pain: 9, pain_comment: nil, tiredness: 5, tiredness_comment: nil, drowsiness: 7, drowsiness_comment: nil, nausea: 8, nausea_comment: nil, lack_of_appetite: 9, lack_of_appetite_comment: nil, shortness_of_breath: 5, shortness_of_breath_comment: nil, depression: 5, depression_comment: nil, wellbeing: 7, wellbeing_comment: nil, other_sypmtom_id: urine.id, other_sypmtom_score: 3, other_sypmtom_comment: "Slightly better today", esas_comment: nil)
...
Comment.create(patient_id: apwinderbrar.id, clinician_id: macariogarcia.id, from: macariogarcia.id, time: "09:08:56 2014-10-04", general_comment: "Let me know if it's still bad tomorrow and we can schedule something from there")
Comment.create(patient_id: apwinderbrar.id, clinician_id: macariogarcia.id, from: apwinderbrar.id, time: "08:43:21 2014-10-06", general_comment: "Seems like it was just a bad day")
