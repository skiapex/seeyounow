...
cns = Occupation.create(name: "Clinical Nurse Specialist", pronym: nil, acronym: "CNS")
...
cardiovascular_nursing = Speciality.create(name: "Cardiovascular Nursing", occupation_id: cns.id)
community_nursing = Speciality.create(name: "Community Health Nursing", occupation_id: cns.id)
critical_nursing = Speciality.create(name: "Critical Care Nursing", occupation_id: cns.id)
pediatric_nursing = Speciality.create(name: "Critical Care Pediatric Nursing", occupation_id: cns.id)
emergency_nursing = Speciality.create(name: "Emergency Nursing", occupation_id: cns.id)
enterostomal_nursing = Speciality.create(name: "Enterostomal Therapy Nursing", occupation_id: cns.id)
gastroenterology_nursing = Speciality.create(name: "Gastroenterology Nursing", occupation_id: cns.id)
gerontological_nursing = Speciality.create(name: "Gerontological Nursing", occupation_id: cns.id)
hospice_nursing = Speciality.create(name: "Hospice Palliative Care Nursing", occupation_id: cns.id)
surgical_nursing = Speciality.create(name: "Medical-Surgical Nursing", occupation_id: cns.id)
nephrology_nursing = Speciality.create(name: "Nephrology Nursing", occupation_id: cns.id)
neuroscience_nursing = Speciality.create(name: "Neuroscience Nursing", occupation_id: cns.id)
oh_nursing = Speciality.create(name: "Occupational Health Nursing", occupation_id: cns.id)
oncology_nursing = Speciality.create(name: "Oncology Nursing", occupation_id: cns.id)
orthopaedic_nursing = Speciality.create(name: "Orthopaedic Nursing", occupation_id: cns.id)
perianesthesia_nursing = Speciality.create(name: "Peri Anesthesia Nursing", occupation_id: cns.id)
perinatal_nursing = Speciality.create(name: "Perinatal Nursing", occupation_id: cns.id)
perioperative_nursing = Speciality.create(name: "Perioperative Nursing", occupation_id: cns.id)
palliative_nursing = Speciality.create(name: "Palliative Nursing", occupation_id: cns.id)
psychiatric_nursing = Speciality.create(name: "Psychiatric and Mental Health Nursing", occupation_id: cns.id)
rehabilitation_nursing = Speciality.create(name: "Rehabilitation Nursing", occupation_id: cns.id)
...
systemadministration = CareGroup.create(name: "System Admin", city: "North Vancouver", province: "BC")
...
administrator = Clinician.create(first_name: "System", last_name: "Admin", occupation_id: physician.id, speciality_id: gp.id, gender_id: male.id, office_number: "(778) 791-4134", mobile_number: "(778) 791-4134", emergency_message: "Contact info@seeyounow.ca", care_group_id: systemadministration.id, administrator: true, user_id: useradmin.id)


judymaynard = Clinician.create(first_name: "Judy", last_name: "Maynard", occupation_id: physician.id, speciality_id: gp.id, gender_id: female.id, office_number: "(905) 792-2212", mobile_number: "(416) 232-5094", emergency_message: "INSTEAD OF CALLING 911 Your doctor and nurses would like you to call the Brameast Health Care Organization instead. From 8am-8pm call your CCAC nurse at (866) 570-8505, or Amanda at (416) 371-0733 or Dr. Maynard's office at (905) 792-2211. If this is after office hours have closed: from 8pm to 8am or on the weekend please call the on call Brameast physician at (416) 232-5094. Leave a message and your phone number twice so that the on call physician can call you back. Please speak clearly.", care_group_id: brameast.id, administrator: true, user_id: userjudymaynard.id)
amandamaclennen = Clinician.create(first_name: "Amanda", last_name: "MacLennen", occupation_id: rn.id, speciality_id: palliative_nursing.id, gender_id: female.id, office_number: "(905) 792-2212", mobile_number: "(416) 371-0733", emergency_message: "INSTEAD OF CALLING 911 Your doctor and nurses would like you to call the Brameast Health Care Organization instead. From 8am-8pm call your CCAC nurse at (866) 570-8505, or Amanda at (416) 371-0733 or Dr. Maynard's office at (905) 792-2211. If this is after office hours have closed: from 8pm to 8am or on the weekend please call the on call Brameast physician at (416) 232-5094. Leave a message and your phone number twice so that the on call physician can call you back. Please speak clearly.", care_group_id: brameast.id, administrator: true, user_id: useramandamaclennen.id)
jenniferpebenito = Clinician.create(first_name: "Jennifer", last_name: "Pe Benito", occupation_id: rn.id, speciality_id: palliative_nursing.id, gender_id: female.id, office_number: "(905) 792-2212", mobile_number: "(416) 371-0733", emergency_message: "INSTEAD OF CALLING 911 Your doctor and nurses would like you to call the Brameast Health Care Organization instead. From 8am-8pm call your CCAC nurse at (866) 570-8505, or Amanda at (416) 371-0733 or Dr. Maynard's office at (905) 792-2211. If this is after office hours have closed: from 8pm to 8am or on the weekend please call the on call Brameast physician at (416) 232-5094. Leave a message and your phone number twice so that the on call physician can call you back. Please speak clearly.", care_group_id: brameast.id, administrator: true, user_id: userjenniferpebenito.id)

# Create the patients
puts "Creating patients..."

gailh = Patient.create(clinician_id: judymaynard.id, first_name: "Gail", last_name: "H", user_id: usergailh.id, diagnosis: "Ovarian cancer", diagnosis_date: "2013-03-01 00:00:01 -0400", gender_id: female.id, birth_date: "1946-08-28 00:00:01 -0400", address: "Hanover Road, Brampton, Ontario", phone_number: "1111111", goals_of_care: "stay at home as long as possible; fiercely independent and lives alone", important_to_you: "does not get along with sister Donna who should not be allowed in at the end", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
amrikg = Patient.create(clinician_id: judymaynard.id, first_name: "Amrik", last_name: "G", user_id: useramrikg.id, diagnosis: "Pseudomyxoma Peritonei and Dementia", diagnosis_date: "2014-01-26 00:00:01 -0400", gender_id: male.id, birth_date: "1926-08-28 00:00:01 -0400", address: "116 Eagleridge Drive, Brampton, Ontario", phone_number: "905-753-9323", other_symptom: nil, goals_of_care: "palliate", important_to_you: "Has increasing Dementia and he has lived along time with this diagnosis which no signs of terminal course; will likely die of dementia vs PMP", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
atnafug = Patient.create(clinician_id: judymaynard.id, first_name: "Atnafu", last_name: "G", user_id: useratnafug.id, diagnosis: "Leukemia", diagnosis_date: "2008-08-26 00:00:01 -0400", gender_id: male.id, birth_date: "1940-08-28 00:00:01 -0400", address: "1 Luella Cres, Brampton, Ontario", phone_number: "416-509-3740", other_symptom: nil, goals_of_care: "on chemo pill and doing very well", important_to_you: "Originates from Ethiopia; here with wife living with son and his grandkids", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
harbanss = Patient.create(clinician_id: judymaynard.id, first_name: "Harbans", last_name: "S", user_id: userharbanss.id, diagnosis: "B Cell Lymphoma", diagnosis_date: "2014-11-26 00:00:01 -0400", gender_id: male.id, birth_date: "1943-08-28 00:00:01 -0400", address: "4 Idaho Road, Brampton, Ontario", phone_number: "416-984-0173", other_symptom: nil, goals_of_care: "He wishes to die at home", important_to_you: "Wife does not want us to talk about his prognosis. She knows but would prefer to not hear anything of it.", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: true, patient_archived: false)
lihwah = Patient.create(clinician_id: judymaynard.id, first_name: "Li Hwa", last_name: "H", user_id: userlihwah.id, diagnosis: "Non small cell Lung Cancer", diagnosis_date: "2006-08-26 00:00:01 -0400", gender_id: female.id, birth_date: "1959-08-28 00:00:01 -0400", address: "45 Solway Avenue, Brampton, Ontario", phone_number: "905-846-5907", other_symptom: nil, goals_of_care: "comfort and ongoing chemo; not interested in anymore lung biopsies as they pick up dead cells only times 3", important_to_you: "Dr. Nada rajah is her FD and she is not quite ready to switch to our service", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
nalinim = Patient.create(clinician_id: judymaynard.id, first_name: "Nalini", last_name: "M", user_id: usernalinim.id, diagnosis: "Metastatic colorectal cancer", diagnosis_date: "2015-01-26 00:00:01 -0400", gender_id: female.id, birth_date: "1974-08-28 00:00:01 -0400", address: "28 Lent Cres, Brampton, Ontario", phone_number: "289-752-8191", other_symptom: nil, goals_of_care: "She is aiming for cure. Will be having tumours surgically removed from the liver. Any treatments will be considered.", important_to_you: "She will likely set the pace of our visits ongoing", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
ritab = Patient.create(clinician_id: judymaynard.id, first_name: "Rita", last_name: "B", user_id: userritab.id, diagnosis: "Metastatic Breast Cancer in 2005", diagnosis_date: "2014-08-26 00:00:01 -0400", gender_id: female.id, birth_date: "1955-08-28 00:00:01 -0400", address: "147 Coastline Drive, Brampton, Ontario", phone_number: "905-453-5424", other_symptom: nil, goals_of_care: "palliate", important_to_you: "Strong Sikh religion and knows it is her god who will decide when it is time to go", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
walterh = Patient.create(clinician_id: judymaynard.id, first_name: "Walter", last_name: "H", user_id: userwalterh.id, diagnosis: "Metastatic Rectal Cancer", diagnosis_date: "2011-11-26 00:00:01 -0400", gender_id: male.id, birth_date: "1961-08-28 00:00:01 -0400", address: "13 Burt Drive, Brampton, Ontario", phone_number: "905-453-3651", other_symptom: nil, goals_of_care: "Be painfree and so far continue with chemotherapy despite side effects", important_to_you: "Originates from Newfoundland; has 3 kids", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: true, patient_archived: true)
royele = Patient.create(clinician_id: judymaynard.id, first_name: "Royel", last_name: "E", user_id: userroyele.id, diagnosis: "Large B Cell Lymphoma", diagnosis_date: "2014-10-26 00:00:01 -0400", gender_id: male.id, birth_date: "1946-08-28 00:00:01 -0400", address: "40 Woodsend Run, Brampton, Ontario", phone_number: "647-222-1636", other_symptom: nil, goals_of_care: "palliate", important_to_you: "installed the Bell phones in our Brameast plaza; loved this work", shared_with: [judymaynard.id, amandamaclennen.id, jenniferpebenito.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
