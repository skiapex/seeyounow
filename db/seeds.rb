...
gailh = Patient.create(clinician_id: judymaynard.id, first_name: "Gail", last_name: "H", user_id: usergailh.id, diagnosis: "Ovarian cancer", diagnosis_date: "2013-03-01 00:00:01 -0400", gender_id: female.id, birth_date: "1946-08-28 00:00:01 -0400", address: "Hanover Road, Brampton, Ontario", phone_number: "1111111", goals_of_care: "stay at home as long as possible; fiercely independent and lives alone", important_to_you: "does not get along with sister Donna who should not be allowed in at the end", shared_with: [judymaynard.id, amandamaclennen.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
amrikg = Patient.create(clinician_id: judymaynard.id, first_name: "Amrik", last_name: "G", user_id: useramrikg.id, diagnosis: "Pseudomyxoma Peritonei and Dementia", diagnosis_date: "2014-01-26 00:00:01 -0400", gender_id: male.id, birth_date: "1926-08-28 00:00:01 -0400", address: "116 Eagleridge Drive, Brampton, Ontario", phone_number: "905-753-9323", other_symptom: nil, goals_of_care: "palliate", important_to_you: "Has increasing Dementia and he has lived along time with this diagnosis which no signs of terminal course; will likely die of dementia vs PMP", shared_with: [judymaynard.id, amandamaclennen.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
...
harbanss = Patient.create(clinician_id: judymaynard.id, first_name: "Harbans", last_name: "S", user_id: userharbanss.id, diagnosis: "B Cell Lymphoma", diagnosis_date: "2014-11-26 00:00:01 -0400", gender_id: male.id, birth_date: "1943-08-28 00:00:01 -0400", address: "4 Idaho Road, Brampton, Ontario", phone_number: "416-984-0173", other_symptom: nil, goals_of_care: "He wishes to die at home", important_to_you: "Wife does not want us to talk about his prognosis. She knows but would prefer to not hear anything of it.", shared_with: [judymaynard.id, amandamaclennen.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
...
ritab = Patient.create(clinician_id: judymaynard.id, first_name: "Rita", last_name: "B", user_id: userritab.id, diagnosis: "Metastatic Breast Cancer in 2005", diagnosis_date: "2014-08-26 00:00:01 -0400", gender_id: female.id, birth_date: "1955-08-28 00:00:01 -0400", address: "147 Coastline Drive, Brampton, Ontario", phone_number: "905-453-5424", other_symptom: nil, goals_of_care: "palliate", important_to_you: "Strong Sikh religion and knows it is her god who will decide when it is time to go", shared_with: [judymaynard.id, amandamaclennen.id], care_group_id: brameast.id, patient_deceased: false, patient_archived: false)
