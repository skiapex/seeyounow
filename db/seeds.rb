...
EsasAssesment.create(patient_id: johndoe.id, time: "12:03:32 2014-10-04", inputter_name: "Jane Doe", inputter_id: "partner.id", pain: 4, pain_comment: nil, tiredness: 6, tiredness_comment: nil, drowsiness: 6, drowsiness_comment: nil, nausea: 3, nausea_comment: nil, lack_of_appetitie: 8, lack_of_appetitie_comment: nil, shortness_of_breath: 2, shortness_of_breath_comment: nil, depression: 2, depression_comment: nil, wellbeing: 4, wellbeing_comment: nil, other_sypmtom_id: constipation.id, other_sypmtom_score: 9, other_sypmtom_comment: nil, esas_comment: "Constipation 9 took 3 laxitives and now 2 hours later feeling good result")
EsasAssesment.create(patient_id: cindypeters.id, time: "12:08:56 2014-10-04", inputter_name: "Paul Ku", inputter_id: "care_aid.id", pain: 7, pain_comment: nil, tiredness: 5, tiredness_comment: nil, drowsiness: 6, drowsiness_comment: nil, nausea: 8, nausea_comment: nil, lack_of_appetitie: 7, lack_of_appetitie_comment: nil, shortness_of_breath: 4, shortness_of_breath_comment: nil, depression: 5, depression_comment: nil, wellbeing: 6, wellbeing_comment: nil, other_sypmtom_id: sweating.id, other_sypmtom_score: 4, other_sypmtom_comment: "Still leading to dehydration", esas_comment: nil)

# Create the scores for an PFRS assesment
PrfsAssesment.create(patient_id: johndoe.id, time: "17:46 2014-10-05", inputter_name: "Jane Doe", inputter_id: "partner.id", activity_and_function: 2, prfs_comment: nil)
PrfsAssesment.create(patient_id: cindypeters.id, time: "17:53 2014-10-05", inputter_name: "Paul Ku", inputter_id: "care_aid.id", activity_and_function: 3, prfs_comment: nil)
